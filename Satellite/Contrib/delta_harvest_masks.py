...
def delta_harvest_masks(tile_x, tile_y, size_x=512, size_y=512, pre_window=2, post_window=2):
    ...
    save_location = os.path.join("masks", "harvested")
...
if __name__ == "__main__":
    ...
    delta_harvest_masks(tile_x=7680, tile_y=10240)